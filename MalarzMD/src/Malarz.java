    ...
    private void CanvasMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CanvasMouseMoved
        if (draw_figure == true) {
            ...
            if (cbTool.getSelectedIndex() == 1) {
                ...
                graphics2D.fillPolygon(new int[] {first_mouse_x, old_mouse_x, old_mouse_x, first_mouse_x}, new int[] {first_mouse_y, first_mouse_y, old_mouse_y, old_mouse_y}, 4);
                graphics2D.setColor(brushColor);
                graphics2D.fillPolygon(new int[] {first_mouse_x, evt.getX(), evt.getX(), first_mouse_x}, new int[] {first_mouse_y, first_mouse_y, evt.getY(), evt.getY()}, 4);
            ...
            if (cbTool.getSelectedIndex() == 4) {                
                graphics2D.setColor(Color.WHITE);
                graphics2D.fillPolygon(new int[] {first_mouse_x, (first_mouse_x + old_mouse_x)/2, old_mouse_x}, new int[] {old_mouse_y, first_mouse_y, old_mouse_y}, 3);
                graphics2D.setColor(brushColor);
                graphics2D.fillPolygon(new int[] {first_mouse_x, (first_mouse_x + evt.getX())/2, evt.getX()}, new int[] {evt.getY(), first_mouse_y, evt.getY()}, 3);
            }
